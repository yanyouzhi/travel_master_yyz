...
public class ChangeEmailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManager sessionManager = new SessionManager(ChangeEmailActivity.this);
    ...
    private void editEmail() {
        ...
        Call<BaseResponse> call = apiService.editEamil(token, requestBody);
        ...
        call.enqueue(new Callback<BaseResponse>() {
            ...
            public void onFailure(Call<BaseResponse> call, Throwable t) {
                Toast.makeText(ChangeEmailActivity.this, "网络错误：" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}