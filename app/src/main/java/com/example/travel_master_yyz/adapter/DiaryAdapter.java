...
public class DiaryAdapter extends RecyclerView.Adapter<DiaryAdapter.ViewHolder> {
    ...
    private List<NewCommunityResponse.NewCommunityPost> diaryList;
    private boolean isLiked = false;
    private String token,postUserId,loginId;

    public DiaryAdapter(Context context, List<NewCommunityResponse.NewCommunityPost> diaryList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        NewCommunityResponse.NewCommunityPost diary = diaryList.get(position);
